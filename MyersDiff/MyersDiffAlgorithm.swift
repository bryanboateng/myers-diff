class MyersDiffAlgorithm {
    class func diff(between s1: String, and s2: String) -> Diff {
        let s1Lines: [Line] = {
            var lines =  [Line]()
    ...
    private class func backtrack(between s1: [Character], and s2: [Character]) -> [BacktrackStep] {
    ...
    private class func shortestEdit(between s1: [Character], and s2: [Character]) -> [[Int: Int]] {
        let n = s1.count
        let m = s2.count
        let max = n + m
